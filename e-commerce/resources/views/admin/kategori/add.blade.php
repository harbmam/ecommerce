            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <div class="mb-2 ">
                             <a href="{{ url('admin/kategori/list')}}" class="btn btn-primary">Kembali</a>
                            </div>
                            <div class="card">
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10 form-group">
                                                        <input type="text" id="first-name" class="form-control" name="nama" required value="{{ old('nama') }}" placeholder="Nama Kategori">
                                                    </div>
                                                    ...
                                                    <div class="col-md-10 form-group">
                                                        <input type="text" id="first-name" class="form-control" name="keyword" required value="{{ old('keyword') }}" placeholder="Tulis Kata Kunci">
                                                    </div>
