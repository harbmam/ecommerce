                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10 form-group">
                                                        <input type="text" id="first-name" class="form-control" name="nama" required value="{{ old('nama', $getRecord->nama) }}" placeholder="Nama color">
                                                    </div>
                                                    ...
                                                    <div class="col-md-10 form-group">
                                                        <input type="color" id="first-name" class="form-control" name="code" required value="{{ old('code', $getRecord->code) }}" placeholder="code Ex. URL">
