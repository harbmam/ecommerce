            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <div class="mb-3 ">
                             <a href="{{ url('admin/brand/add')}}" class="btn btn-primary">Tambah</a>
                            </div>
                             <!-- table striped -->
                             @php
                                $no = 1;
                                ...
                                <tbody>
                                    ...
                                    @foreach ($getRecord as $val)
                                     <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/brand/edit/' . $val->id) }}" class="btn btn-warning">Edit</a>
                                            <form action="{{ url('admin/brand/delete/' . $val->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
